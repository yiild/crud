...
export declare class RepositoryService<T> extends RestfulService<T> {
    ...
    getManyAndCount(query?: RequestParamsParsed, options?: RestfulOptions): Promise<[T[], number]>;
    getOne(id: number, { where, fields, include, cache }?: RequestParamsParsed, options?: RestfulOptions): Promise<T>;
